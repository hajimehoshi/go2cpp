...
func writeJSCS(dir string, namespace string) error {
	f, err := os.Create(filepath.Join(dir, "JS.cs"))
	if err != nil {
		return err
	}
	defer f.Close()
...
var jsTmpl = template.Must(template.New("JS.cs").Parse(`// Code generated by go2dotnet. DO NOT EDIT.
...
namespace {{.Namespace}}
{
    ...
    public delegate object JSFunc(object self, object[] args);
